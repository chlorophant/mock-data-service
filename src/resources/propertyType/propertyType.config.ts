...
const post_validation = {
  body: t.Object({
    propertyTypeName: t.String(),
    propertyTypeDescription: t.String(),
    ranking: t.Integer(),
    createdBy: t.String(),
...
const patch_validation = {
  ...
  body: t.Object({
    propertyTypeName: t.Optional(t.String()),
    propertyTypeDescription: t.Optional(t.String()),
